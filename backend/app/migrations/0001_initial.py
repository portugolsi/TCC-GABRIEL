# Generated by Django 4.1.3 on 2023-11-11 17:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nomePerfil', models.CharField(help_text='Nome que aparecerá no perfil', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('imagem', models.ImageField(help_text='Imagem do post', upload_to='posts')),
                ('legenda', models.TextField(blank=True, help_text='Legenda')),
